...
<head>
    ...
    <script>
        ...
        function findDataMapList() {
            var obj = $("#list");
            var url = "test/dataMap/dataMapList?scriptId="+$("#txtScriptId").val();
            var columns = [{
                "data" : "id"
                },{
                    "data" : "name"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="insertDataMap();" id="btnAddDataMap">确定</button>
