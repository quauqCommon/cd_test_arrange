    ...
    <script>
        ...
        function insertScript(){
            $.ajax({
                ...
                data : {
                	"name" : $("#txtScriptName").val(),
    				"content" : $("#txtScriptContent").val(),
    				"comment" : $("#txtScriptComment").val(),
    				"category" : $("#secCategory").val(),
    				"selfCategory" : $("#secSelfCategory").val(),
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class='main-content'>
                    ...
                    <select id="secProject" onchange="changeProject(this)" class="form-control" />
                </div>
                <div class='main-content'>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="insertScript();" id="btnAddScript">确定</button>
